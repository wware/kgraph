"""Canonical ID model and cache interface for knowledge graph ingestion.

This module provides abstractions for canonical ID lookup and caching that can be
used across different knowledge domains.
"""
